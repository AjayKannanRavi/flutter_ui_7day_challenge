...
// Top header bar that includes back, favorite, share, and cart icons
class ProductHeader extends StatelessWidget {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          // Right side: Heart, Share, and Cart buttons
          Row(
            children: [
  ...
  Widget _buildIconButton(String imagePath) {
    return Container(
      ...
      // Tries to load image from assets; shows fallback icon if missing
      child: Image.asset(
        imagePath,
        fit: BoxFit.contain,
        errorBuilder: (context, error, stackTrace) {
          // Handles missing asset gracefully with built-in icons
          IconData icon;
